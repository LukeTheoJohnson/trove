...
SOURCE_GROUPS = {
    ...
    "fuel & electricity":               ("spainfuel", "petrolspy", "em6", "octopus", "aemo", "fuelwatch", "awattar", "carbonintensity", "nyiso", "francefuel", "energinet", "aeso", "elexon", "ree", "elia", "italyfuel", "austriafuel"),
    "currency & macro":                 ("frankfurter", "paralelobo", "dolarapi"),
    "deals, fares & listings":          ("grabone", "grabaseat", "bookme", "turners", "eventcinemas", "reverb"),
    "attention & rank":                 ("hackernews", "appcharts", "melbped"),
    "weather, environment & geohazard": ("geonet", "metno", "volcano", "nzski", "gwrivers", "avalanche", "mdcrivers", "nswrfs", "beachwatch", "vicemergency", "horizonsrivers", "northlandrivers", "westcoastrivers", "sacfs", "safeswim", "eafloods", "usgs", "wildfire", "airquality", "usgsquakes", "hkweather", "ipma", "luchtmeetnet", "hbrivers", "eqcanada", "imgw", "bmkg", "turkeyquake", "jmaquake", "usgsvolcano", "gdacs", "jmaweather", "meteireann", "buienradar", "fmi", "smhi", "icelandweather", "sgrain"),
    "space":                            ("spaceweather", "sentry", "spacelaunch"),
    "aviation":                         ("chcflights", "zqnflights", "opensky", "adsblol", "adsbfi"),
    "roads & transport":                ("nzroads", "tfl", "mbta", "swisstransport", "bcferries"),
    "shared mobility":                  ("bikeshare", "sgtaxi"),
    "sports & recreation":              ("squiggle", "espnscores"),
    "parking":                          ("chcparking", "sgcarpark"),
    "utilities & outages":              ("outages",),
    "marine & coastal":                 ("noaatides", "ndbc", "uktides"),
